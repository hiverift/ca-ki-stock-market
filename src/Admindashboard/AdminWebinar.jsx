...
const AdminWebinarTable = () => {
  const [meetVisible, setMeetVisible] = useState({});
 ...
 const fetchWebinars = async () => {
  ...
  const handleSaveWebinar = async () => {
    ...
    try {
      ...
      if (newWebinar.categoryId)
        form.append("categoryId", newWebinar.categoryId);
      ...
      if (!res.ok) {
        return Swal.fire(
          "Error",
          data.message || "Error saving webinar",
          "error"
        );
      }
      ...
      Swal.fire({
        ...
        text: editId
          ...
          : "Webinar has been saved successfully.",
        icon: "success",
