      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 mb-16 space-y-8 font-sans ">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 px-6 md:px-12 lg:px-20 py-12 bg-white">
          ...
          <div className="md:w-1/2 space-y-6">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              platform founded with a clear mission:{" "}
            ...
            <p className="text-gray-600 leading-relaxed">
              We are dedicated to providing high-quality financial education
              that empowers individuals to make informed investment decisions.
              Our platform serves as a beacon of trust in an industry often
              plagued by fraudulent advisory services.
            </p>
              ...
              <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8 lg:gap-12">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-700 text-sm sm:text-base leading-relaxed mb-8 text-center lg:text-left">
                    CA Paras Muradia is a seasoned Chartered Accountant with
                    over 12 years of professional experience in Financial
                    Planning, Accounts Management, Taxation, and Trading. As the
                    founder of this initiative, he combines deep financial
                    expertise with practical market insights to guide
                    individuals toward smarter financial decisions. Beyond his
                    core CA background, Paras Muradia is also a trusted trading
                    coach and mentor, helping learners understand market
                    behaviour, risk management, and disciplined trading
                    strategies. His personalised coaching sessions and practical
                    approach empower individuals to trade confidently and
                    responsibly. In addition to trading mentorship, he provides
                    one-on-one consultancy for business growth, helping
                    entrepreneurs optimise finances, streamline operations, and
                    build scalable, profitable business models. Led by
                    experience, integrity, and a commitment to financial
                    clarity, CA Paras Muradia aims to support individuals and
                    businesses in unlocking their full financial potential.
                  </p>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <blockquote className="text-gray-700 text-sm sm:text-base leading-relaxed italic">
                      "To provide affordable, transparent & authentic financial
                      education that empowers individuals to make informed
                      investment decisions. My goal is to create a platform
                      where ethical practices prevail and students can learn
                      without the fear of fraudulent advice."
                    </blockquote>
                  </div>
                </div>
              </div>
        ...
        <div className="border-t-2  py-12 px-6 md:px-12 lg:px-20 bg-white border md:border-gray-200 rounded-md">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 text-sm md:text-base mt-2">
              We stand apart from other platforms through our commitment to
              authenticity
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 ">
            ...
            <div className="bg-white p-6 rounded-xl    flex flex-col items-center text-center ">
              ...
              <h2 className="text-lg  text-gray-900 mb-2">CA Certified</h2>
            ...
            <div className="bg-white p-6 rounded-xl   flex flex-col items-center text-center ">
              ...
              <h2 className="text-lg d text-gray-900 mb-2">SEBI Compliant</h2>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-xl    flex flex-col items-center text-center ">
              ...
              <h2 className="text-lg  text-gray-900 mb-2">Community Focus</h2>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-xl   flex flex-col items-center text-center">
              ...
              <h2 className="text-lg  text-gray-900 mb-2">Student First</h2>
              <p className="text-gray-600 text-sm leading-relaxed">
                Your success is our priority - affordable, accessible education
                for all
              </p>
            </div>
          </div>
        ...
        <div className="bg-yellow-400 py-10 px-6 md:px-12 lg:px-20 text-center rounded-md">
          ...
          <p className="text-base sm:text-lg md:text-md text-gray-800 mb-6 mx-auto">
            Be part of the change towards transparent and authentic financial
            education
          </p>
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            <button
              onClick={handleExploreCourses}
              className="w-full sm:w-auto bg-gray-900 text-white px-6 py-1 rounded-md hover:bg-gray-800 transition"
            >
              Explore Our Courses
            </button>
            <button
              onClick={handleGetInTouch}
              className="w-full sm:w-auto bg-white  text-gray-900 border border-gray-900 px-6 py-1 rounded-md md:hover:bg-gray-900 md:hover:text-white
         transition"
            >
              Get in Touch
            </button>
