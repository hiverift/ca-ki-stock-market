    ...
    <div className="pt-24">
      <div className="text-white text-center text-lg mx-auto px-4 sm:px-6 lg:px-8 space-y-4 max-w-7xl">
          ...
          {webinars.map((webinar) => (
            ...
            >
              <div className="p-4 flex flex-col flex-1">
                ...
                <h3 className="text-md text-gray-600 mb-1">{webinar.title}</h3>
              ...
              <div className="bg-gray-50 px-4 py-4 flex items-center justify-between mt-auto border-t">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  {/* 👉 If user has paid, backend will send googleMeetLink */}
                  {webinar.googleMeetLink ? (
                    <a
                      href={webinar.googleMeetLink}
                      target="_blank"
                      className="px-4 py-2 rounded-md text-xs font-medium bg-green-500 hover:bg-green-600 text-white"
                    >
                      Join Webinar
                    </a>
                  ) : (
                    <button
                      ...
                      className="px-4 py-2 rounded-md text-xs font-medium bg-yellow-400 hover:bg-yellow-500 text-gray-900"
                    >
        ...
        <section className="w-full px-4 sm:px-6 lg:px-8 mt-10 mb-16">
          <h2 className="text-md font-bold text-gray-800 mb-8">Browse by Specialization</h2>
